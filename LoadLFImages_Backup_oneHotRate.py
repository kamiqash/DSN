...
#--------------------------------------- 56 Views Work ----------------------------------------------------------------
# Depth0 reading
def LoadFiftySixViewsDepth0(TotLF,ctuPath,metaPath,rate,r22,r27,r32,PRINT_STATUS,METHODOLOGY,DB):
    Record=[]
    sz1 = 256
    sz2 = sz1 * 2
    MVX_1 = np.zeros(sz2)
            ...
            for lfC in range(1, 10):
                ...
                for CTUno in range(0, 64):
                    ...
                    with open(pufilenameCurrInfo) as fpucurr:
                        ...
                        CurrPU = (int(fpucurr.readline()))/10  # / 1
                    ...
                    if (METHODOLOGY): # IF we need to predict complete LF views
                        Record.append(
                            [pufilenameCurrInfo_CTU, lfname, lfR, lfC, r22,r27,r32, CTUno, CurrPU, CurrSL, N1PU, N2PU, N3PU, N4PU,
                        ...
                        if (testSR.any() and testSC.any()):
                            ...
                            Record.append([pufilenameCurrInfo_CTU, lfname, lfR, lfC, r22,r27,r32, CTUno, CurrPU, CurrSL, N1PU, N2PU, N3PU,N4PU,
...
## Depth 2 reading
def LoadFiftySixViewsDepth2(TotLF,ctuPath,metaPath,rate,r22,r27,r32,PRINT_STATUS,FULL_LF,DB):
    Record_Depth2=[]
    sz1 = 256
    sz2 = sz1 * 2
    MVX_1 = np.zeros(sz2)
                            ...
                            if (os.path.exists(pufilenameCurrInfo)):
                                ...
                                if (FULL_LF):
                                    Record_Depth2.append(
                                        [pufilenameCurrInfo_CTU, lfname, lfR, lfC, r22,r27,r32, CTUno, CurrPU, CurrSL, N1PU, N2PU,
                                         N3PU,
                                    ...
                                    if (testSR.any() and testSC.any()):
                                        ...
                                        Record_Depth2.append(
                                            [pufilenameCurrInfo_CTU, lfname, lfR, lfC, r22,r27,r32, CTUno, CurrPU, CurrSL, N1PU, N2PU, N3PU,
